...
#define FYP_VULKAN_RENDERER_RENDERER_HPP
...
public:
     ...
     *
     * The frame waits on the current fence, acquires a swapchain image, records
     * dynamic-rendering commands, submits them to the graphics queue, and
     * presents the image.  Image layout transitions use synchronization2
     * barriers only.
     *
     * @param  ctx      Fully initialised VulkanContext.
...
#endif // FYP_VULKAN_RENDERER_RENDERER_HPP
